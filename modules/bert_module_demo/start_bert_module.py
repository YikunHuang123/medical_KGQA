...
class BertIntentModel(object):
    def __init__(self):
        ...
        self.dict_path = r'./chinese_rbtl3_L-3_H-1024_A-16/vocab.txt'
        self.config_path=r'./chinese_rbtl3_L-3_H-1024_A-16/bert_config_rbtl3.json'
        # self.checkpoint_path=r'../../chinese_rbtl3_L-3_H-1024_A-16/bert_model.ckpt'
        self.checkpoint_path=r'./chinese_rbtl3_L-3_H-1024_A-16/bert_model.ckpt'

        self.label_list = [line.strip() for line in open('./modules/bert_module_demo/label','r',encoding='utf8')]
        self.id2label = {idx:label for idx,label in enumerate(self.label_list)}

        self.tokenizer = Tokenizer(self.dict_path)
        self.model = build_bert_model(self.config_path,self.checkpoint_path,13)
        self.model.load_weights(r'./data/best_model.weights')
